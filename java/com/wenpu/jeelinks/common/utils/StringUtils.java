...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static List<Long> toArray(String str){
        ...
        String[] vArr = StringUtils.splitByWholeSeparator(str,",");
    ...
    public static List<String> toArray2(String str){
 ...
 public static List<String> toArray3(String str){
    ...
    //list增加不重复的字符串元素
   public static List<String> addStringWidthNoRepeat(List<String> list,String str){
	   boolean flag=true;
   ...
   //array转字符串
   public static String ArrayToStr(String[] array,String separate){
	   String str="";
   ...
   public static String replaceBr( String str){
	   if(str!=null){
		  ...
		  // str=str.replace("(\r\n|\r|\n|\n\r)", "<br/>");
		   ...
		   String res = str.replaceAll("(\0|\\s*)", "&nbsp");
