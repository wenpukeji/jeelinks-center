...
import com.wenpu.jeelinks.common.utils.FileUtils;
...
public class CKFinderConnectorServlet extends ConnectorServlet {
	...
	private void prepareGetResponse(final HttpServletRequest request,
		...
		// 快捷上传，自动创建当前文件夹，并上传到该路径
			...
			if(currentFolder.contains("answerFile"))
			{
				realPath   =  Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL +"answerFile"+ "/" + type + (currentFolder != null ? currentFolder : "");
			}
