...
import com.wenpu.jeelinks.common.security.Digests;
import com.wenpu.jeelinks.common.security.shiro.session.SessionDAO;
import com.wenpu.jeelinks.common.service.BaseService;
import com.wenpu.jeelinks.common.service.ServiceException;
import com.wenpu.jeelinks.common.utils.CacheUtils;
import com.wenpu.jeelinks.common.utils.Encodes;
import com.wenpu.jeelinks.common.utils.StringUtils;
import com.wenpu.jeelinks.common.web.Servlets;
import com.wenpu.jeelinks.modules.center.entity.TLevel;
import com.wenpu.jeelinks.modules.center.service.TLevelService;
import com.wenpu.jeelinks.modules.sys.dao.MenuDao;
import com.wenpu.jeelinks.modules.sys.dao.RoleDao;
import com.wenpu.jeelinks.modules.sys.dao.UserDao;
import com.wenpu.jeelinks.modules.sys.entity.Menu;
...
import com.wenpu.jeelinks.modules.sys.security.SystemAuthorizingRealm;
import com.wenpu.jeelinks.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public int deleteRole(Role role) {
		...
		User user =new User();
		user.setRole(role);
	    List<User> list=userDao.findUserByRoleId(user);
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void setLoginInfo(User user) {
		...
		if(user.getEuser()!=null){
			tlevel.setPoints(user.getEuser().getPoint());
			tlevel.setLevelScope("1");
			List<TLevel> tLevelList = tLevelService.findList(tlevel);
			if (tLevelList != null &&tLevelList.size() >0) {
				tLevelList.get(0).setPoints(tlevel.getPoints());
				user.setTlevel(tLevelList.get(0));
			}else{
				TLevel lev=	new TLevel();
				lev.setLevelName("LV1");
				lev.setPoints(0);
				lev.setToPoint("100");
				user.setTlevel(lev);
			}
