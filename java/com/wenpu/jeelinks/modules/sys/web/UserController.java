...
import com.wenpu.jeelinks.common.utils.excel.ExportExcel;
import com.wenpu.jeelinks.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		model.addAttribute("office", officeService.get(oid));*/
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		if (user.getOffice()!=null){
			user.setCompany(officeService.getCompany(user.getOffice().getId()));
		}
	...
	public String delete(User user, RedirectAttributes redirectAttributes, HttpServletRequest request) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/sys/user/list?repage";
		}
