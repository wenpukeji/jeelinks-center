...
import com.wenpu.jeelinks.modules.sys.security.SystemAuthorizingRealm.Principal;
...
public class UserUtils {
	...
	@SuppressWarnings("unchecked")
	public static List<Office> getOfficeList(String extid){
		List<Office> officeList = null;//(List<Office>)getCache(CACHE_OFFICE_LIST);
		if (officeList == null){
			User user = getUser();
			if (user.isAdmin()){
				...
				officeList = officeDao.findByParentIdsLike(office);
			}else{
	...
	@SuppressWarnings("unchecked")
	public static List<Office> getCompanyList(String extid){
		List<Office> officeList = null;//(List<Office>)getCache(CACHE_OFFICE_LIST);
		if (officeList == null){
			User user = getUser();
			if (user.isAdmin()){
	...
	public static List<Office> getOfficeAllList(String extid){
		@SuppressWarnings("unchecked")
		List<Office> officeList = null;//(List<Office>)getCache(CACHE_OFFICE_ALL_LIST);
		if (officeList == null){
			 
			Office o =new Office();
			o.setParentIds(extid);
			officeList = officeDao.findByParentIdsLike(o);
		}
		return officeList;
	}
	
	public static List<Office> getCompanyAllList(String extid){
		@SuppressWarnings("unchecked")
		List<Office> officeList = null;//(List<Office>)getCache(CACHE_OFFICE_ALL_LIST);
		if (officeList == null){
